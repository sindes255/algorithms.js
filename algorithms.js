var Algorithm = { REVISION: '0' };

/* ========================== Search algorithms ========================== */

/* ============= Linear search ============= */

Algorithm.linearSearch = function(t,A)      // t - target element,
{                                           // A - input array.
    var n = A.length, i = 0;
...
Algorithm.binarySearch = function(t,A)       // t - target element,
{                                            // A - input array.
...
Algorithm.substringSearch = function(sub, str)    // sub - target substring
{                                                 // str - input string
...
Algorithm.bubbleSort = function(A)       // A - input array, that
...
Algorithm.selectionSort = function(A)       // A - input array, that
{                                           // must be sorted by increase.
    var n = A.length;
    for (var i = 0; i < n-1; i++)
    { var min = i;
...
Algorithm.insertionSort = function(A)       // A - input array, that
{                                           // must be sorted by increase.
    var n = A.length;
    for (var i = 0; i < n; i++)
    { var v = A[ i ], j = i-1;
...
Algorithm.shellSort = function(A)
{
...
Algorithm.simpleCountingSort = function(A)
{
...
Algorithm.combSort = function(A)           // A - input array, that
{                                          // must be sorted by increase.
...
Algorithm.mergeSort = function(A)      // A - input array, that
{                                      // must be sorted by increase.
...
Algorithm.quickSort = function(A)
{
    if (A.length == 0) return [];
    var a = [], b = [], p = A[0];
...
Algorithm.cocktailSort = function(A)    //second name is ShakerSort.
{
...
Algorithm.gnomeSort = function(A)
{
...
Algorithm.naturalSort = function(string_array)  // A - input array with string items
{
...
Algorithm.testUnique = function(A)
{
    var n = A.length;
    for (var i = 0; i < n-1; i++)
    { for (var j = i+1; j < n; j++)
...
Algorithm.getUniqueElems = function(A)   // A - input ordered array.
{
    var n = A.length, B = [];
...
Algorithm.getDublsSortArr = function(A)   // A - input ordered array.
{
    var n = A.length, B = [];
...
Algorithm.mergeArray = function(A,B)                     // A и B - input ordered arrays.
{
...
Algorithm.multiMergeArray = function(k,A)   // Calling only with k=0. А - two-dimensional array,
...
Algorithm.intersecArrays = function(A,B)
{
...
Algorithm.multiIntersecArrays = function(k,A) // Calling only with k=0. А - two-dimensional array,
...
Algorithm.intersecSortArr = function(A,B)         // A и B - input ordered array.
{
...
Algorithm.multiIntersecSortArr = function(k,A)  // Calling only with k=0. А - array of two-dimensional array,
{                                             //  his elements - A[ i ] is a ordered arrays there must be crossed.
    var n = A.length;
    if (k == n-2)
...
Algorithm.diffArrays = function(A,B)
{
    var M = A.length, N = B.length, c = 0, C = [];
    for (var i = 0; i < M; i++)
    { var j = 0, k = 0;
...
Algorithm.multiDiffArrays = function(k,A)   // Calling only with k=0. А - two-dimensional array,
...
Algorithm.diffSortArr = function(A,B)     // A и B - input ordered arrays.
{
...
Algorithm.multiDiffSortArr = function(k,A)   // Calling only with k=0. А - array of two-dimensional array,
{                                           //  his elements - A[ i ] is a ordered arrays. Need to find there difference.
    var n = A.length;
    if (k == n-2)
...
Algorithm.symmDiffSortArr = function(A,B)     // A и B - input ordered arrays.
{
...
Algorithm.multiSymmDiffSortArr = function(k,A)   // Calling only with k=0. А - array of two-dimensional array,
...
Algorithm.unionSortArr = function(A,B)             // A и B - input ordered arrays.
{
    var N = A.length, M = B.length, C = [];
...
Algorithm.multiUnionSortArr = function(k,A)  // Calling only with k=0. А - array of two-dimensional array,
{                                            //  his elements - A[ i ] is a ordered arrays. Need to find there symmetric difference.
    var n = A.length;
    if (k == n-2)
...
Algorithm.NOD = function(A){
    return Algorithm.GCD(A)
};

Algorithm.NOK = function(A){
...
Algorithm.transMatrix = function(A)       //two-dimensional input matrix
{
...
Algorithm.sumMatrix = function(A,B)       //two two-dimensional input matrices
{
...
Algorithm.multMatrixNumber = function(a,A)  // a - number, A - two-dimensional input matrix
{
...
Algorithm.multiplyMatrix = function(A,B)
{
...
Algorithm.matrixPow = function(n,A)
{
...
Algorithm.determinantMatrix = function(A)   // Using Bareys's algorithm, difficult O(n^3)
{
...
Algorithm.matrixRank = function(A)
{
...
Algorithm.adjugateMatrix = function(A)   // A - two-dimensional input matrix
{
    var N = A.length, adjA = [];
    for (var i = 0; i < N; i++)
    { adjA[i] = [];
...
Algorithm.inverseMatrix = function(A)   // A - two-dimensional input matrix
{
...
Algorithm.getRandomArbitary = function(min, max)
{
...
Algorithm.getRandomInt = function(min, max)
{
